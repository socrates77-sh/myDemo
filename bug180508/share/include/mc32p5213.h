...
#define INTE0_ADDR      	0x01BA
#define INTF0_ADDR      	0x01BB
...
typedef union {
	 struct {
		unsigned char ISEL0:1;
		unsigned char ISEL1:1;
...
#define ISEL0     	DKW0bits.ISEL0      	/* bit 0 */
#define ISEL1     	DKW0bits.ISEL1      	/* bit 1 */
