...
#define T2CR_ADDR       	0x00EC
#define T2C_ADDR        	0x00ED
#define T2D_ADDR        	0x00EE
...
extern __sfr __at (T2C_ADDR)      	T2C;
extern __sfr __at (T2D_ADDR)      	T2D;
...
#define P45ANS    	ANSELbits.P45ANS    	/* bit 5 */
...
#define ADLEN     	ADRLbits.ADLEN      	/* bit 5 */
...
#define T2PTSX    	TXCRbits.T2PTSX     	/* bit 4 */
...
typedef union {
	 struct {
		...
		unsigned char T2ALOAD:1;
		unsigned char T2PTS:1;
		unsigned char T2PR0:1;
		unsigned char T2PR1:1;
		unsigned char T2PR2:1;
		unsigned char TC2EN:1;
	};
} __T2CRbits_t;
extern volatile __T2CRbits_t __at(T2CR_ADDR) T2CRbits;

#define PWM2OE    	T2CRbits.PWM2OE     	/* bit 0 */
#define BUZ2OE    	T2CRbits.BUZ2OE     	/* bit 1 */
#define T2ALOAD   	T2CRbits.T2ALOAD    	/* bit 2 */
#define T2PTS     	T2CRbits.T2PTS      	/* bit 3 */
#define T2PR0     	T2CRbits.T2PR0      	/* bit 4 */
#define T2PR1     	T2CRbits.T2PR1      	/* bit 5 */
#define T2PR2     	T2CRbits.T2PR2      	/* bit 6 */
...
extern volatile __T2Cbits_t __at(T2C_ADDR) T2Cbits;

#define T2C0      	T2Cbits.T2C0        	/* bit 0 */
#define T2C1      	T2Cbits.T2C1        	/* bit 1 */
#define T2C2      	T2Cbits.T2C2        	/* bit 2 */
#define T2C3      	T2Cbits.T2C3        	/* bit 3 */
#define T2C4      	T2Cbits.T2C4        	/* bit 4 */
#define T2C5      	T2Cbits.T2C5        	/* bit 5 */
#define T2C6      	T2Cbits.T2C6        	/* bit 6 */
#define T2C7      	T2Cbits.T2C7        	/* bit 7 */

// ----- T2D Bits --------------------------------------------
typedef union {
	 struct {
		unsigned char T2D0:1;
		unsigned char T2D1:1;
		unsigned char T2D2:1;
		unsigned char T2D3:1;
		unsigned char T2D4:1;
		unsigned char T2D5:1;
		unsigned char T2D6:1;
		unsigned char T2D7:1;
	};
} __T2Dbits_t;
extern volatile __T2Dbits_t __at(T2D_ADDR) T2Dbits;

#define T2D0      	T2Dbits.T2D0        	/* bit 0 */
#define T2D1      	T2Dbits.T2D1        	/* bit 1 */
#define T2D2      	T2Dbits.T2D2        	/* bit 2 */
#define T2D3      	T2Dbits.T2D3        	/* bit 3 */
#define T2D4      	T2Dbits.T2D4        	/* bit 4 */
#define T2D5      	T2Dbits.T2D5        	/* bit 5 */
#define T2D6      	T2Dbits.T2D6        	/* bit 6 */
#define T2D7      	T2Dbits.T2D7        	/* bit 7 */
