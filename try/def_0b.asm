...
; This file was generated Wed Sep 27 18:08:37 2017
;--------------------------------------------------------
...
; 2 exit points
;	.line	9; "def_0b.c"	c_b = 0b00001111;
	MOVAI	0x0f
	MOVRA	_main_c_b_1_2
;	.line	12; "def_0b.c"	c_a = IOP1;
	MOVAR	_IOP1
	MOVRA	r0x1001
;	.line	14; "def_0b.c"	c_b = MCR;
	MOVAR	_MCR
	MOVRA	_main_c_b_1_2
;	.line	15; "def_0b.c"	c_b = IOP1;
	MOVAR	_IOP1
	MOVRA	_main_c_b_1_2
;	.line	17; "def_0b.c"	IOP0 = c_a + c_b;
	MOVAR	_main_c_b_1_2
	ADDAR	r0x1001
	MOVRA	_IOP0
;	.line	18; "def_0b.c"	IOP1 = c_a - c_b;
	MOVAR	_main_c_b_1_2
	RSUBAR	r0x1001
	MOVRA	_IOP1
;;swapping arguments (AOP_TYPEs 1/2)
;;signed compare: left >= lit(0x1=1), size=1, mask=ff
;	.line	20; "def_0b.c"	if (c_a > 0) IOP0 = c_b;
	MOVAR	r0x1001
	ADDAI	0x80
	ADDAI	0x7f
	JBSET	STATUS,0
...
_00106_DS_
;	.line	22; "def_0b.c"	if (c_a > -3) IOP0 = c_b;
	MOVAR	r0x1001
	ADDAI	0x80
	ADDAI	0x82
	JBSET	STATUS,0
