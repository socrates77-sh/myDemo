...
; This file was generated Wed Sep 27 18:20:28 2017
;--------------------------------------------------------
...
; 2 exit points
;	.line	8; "type_int.c"	c_a = MCR;
	MOVAR	_MCR
	MOVRA	_c_a
	CLRR	(_c_a + 1)
;	.line	9; "type_int.c"	c_b = KBIM;
	MOVAR	_KBIM
	MOVRA	_c_b
	CLRR	(_c_b + 1)
;	.line	10; "type_int.c"	uc_a = MCR;
	MOVAR	_MCR
	MOVRA	_uc_a
	CLRR	(_uc_a + 1)
;	.line	11; "type_int.c"	uc_b = KBIM;
	MOVAR	_KBIM
	MOVRA	_uc_b
	CLRR	(_uc_b + 1)
;	.line	13; "type_int.c"	IOP0 = c_a + c_b;
	MOVAR	_c_a
	MOVRA	r0x1008
	MOVAR	_c_b
	MOVRA	r0x1009
	...
	ADDAR	r0x1008
	MOVRA	_IOP0
;	.line	14; "type_int.c"	IOP0 = uc_a + uc_b;
	MOVAR	_uc_a
	MOVRA	r0x100A
	MOVAR	_uc_b
	MOVRA	r0x100B
	...
	ADDAR	r0x100A
	MOVRA	_IOP0
;	.line	15; "type_int.c"	IOP1 = c_a - c_b;
	MOVAR	r0x1009
	RSUBAR	r0x1008
	MOVRA	_IOP1
;	.line	16; "type_int.c"	IOP1 = uc_a - uc_b;
	MOVAR	r0x100B
	RSUBAR	r0x100A
	MOVRA	_IOP1
;;swapping arguments (AOP_TYPEs 1/3)
;;signed compare: left >= lit(0x1=1), size=2, mask=ffff
;	.line	18; "type_int.c"	if (c_a > 0) IOP0 = c_b;
	MOVAR	(_c_a + 1)
	ADDAI	0x80
	ADDAI	0x80
	JBSET	STATUS,2
...
;;genSkipc:3194: created from rifx:00D4608C
	...
	MOVRA	_IOP0
_00106_DS_
;	.line	19; "type_int.c"	if (uc_a > 0) IOP0 = uc_b;
	MOVAR	_uc_a
	ORAR	(_uc_a + 1)
	JBCLR	STATUS,2
	GOTO	_00108_DS_
...
_00108_DS_
;	.line	21; "type_int.c"	if (c_a > -3) IOP0 = c_b;
	MOVAR	(_c_a + 1)
	ADDAI	0x80
	ADDAI	0x81
	JBSET	STATUS,2
...
_00110_DS_
;	.line	22; "type_int.c"	if (uc_a > -3) IOP0 = uc_b;
	MOVAI	0xff
	RSUBAR	(_uc_a + 1)
	JBSET	STATUS,2
	GOTO	_00130_DS_
