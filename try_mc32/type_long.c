...
void main(void)
{
   ...
   // uc_b = ((ulong)ram4<<24) + ((ulong)ram3<<16) + ((long)ram2<<8) + ram1;
   	...
   	lram = uc_b;
     	...
     	lram = (uc_a + uc_b);
     	ram4 = (uc_a + uc_b)>>24;      	   	   	// 0xb37b03a8
     	ram3 = (uc_a + uc_b)>>16;
     	ram2 = (uc_a + uc_b)>>8;
     	ram1 = (uc_a + uc_b);

     	lram = (c_a - c_b);
     	ram4 = (c_a - c_b)>>24;        	   	   	// 0x2bbab718
     	ram3 = (c_a - c_b)>>16;
     	ram2 = (c_a - c_b)>>8;
     	ram1 = (c_a - c_b);

     	lram = (uc_a - uc_b);
     	ram4 = (uc_a - uc_b)>>24;          	   	   	// 0x93333ca8
     	ram3 = (uc_a - uc_b)>>16;
     	ram2 = (uc_a - uc_b)>>8;
     	ram1 = (uc_a - uc_b);

     	lram = (uc_a + c_b);
     	ram4 = (uc_a + c_b)>>24;       	   	   	// 0x07a58938
     	ram3 = (uc_a + c_b)>>16;
     	ram2 = (uc_a + c_b)>>8;
     	ram1 = (uc_a + c_b);

     	lram = (c_a + uc_b);
     	ram4 = (c_a + uc_b)>>24;           	   	   	// 0xa02d03a8
     	ram3 = (c_a + uc_b)>>16;
     	ram2 = (c_a + uc_b)>>8;
     	ram1 = (c_a + uc_b);

     	lram = (uc_a - c_b);
     	ram4 = (uc_a - c_b)>>24;       	   	   	// 0x80000000?
     	ram3 = (uc_a - c_b)>>16;
     	ram2 = (uc_a - c_b)>>8;
     	ram1 = (uc_a - c_b);

     	lram = (c_a - uc_b);
     	ram4 = (c_a - uc_b)>>24;           	   	   	// 0x80000000?
     	ram3 = (c_a - uc_b)>>16;
     	ram2 = (c_a - uc_b)>>8;
     	ram1 = (c_a - uc_b);
