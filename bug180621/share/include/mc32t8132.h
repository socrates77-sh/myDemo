...
typedef union {
	 struct {
		unsigned char CLKOS0:1;
		unsigned char CLKOS1:1;
		unsigned char CLKOS2:1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
...
#define CLKOS0    	CLKObits.CLKOS0     	/* bit 0 */
#define CLKOS1    	CLKObits.CLKOS1     	/* bit 1 */
#define CLKOS2    	CLKObits.CLKOS2     	/* bit 2 */
...
#define P26PD     	PDP2bits.P26PD      	/* bit 6 */
...
#define ADCHS4    	ADCR0bits.ADCHS4    	/* bit 7 */
...
#define GYS0      	LEDCR0bits.GYS0     	/* bit 0 */
#define GYS1      	LEDCR0bits.GYS1     	/* bit 1 */
#define GYS2      	LEDCR0bits.GYS2     	/* bit 2 */
...
typedef union {
	 struct {
		unsigned char FLED0:1;
		unsigned char FLED1:1;
		unsigned char IREFEN:1;
		unsigned char IBPS0:1;
		unsigned char IBPS1:1;
...
#define FLED0     	LEDCR1bits.FLED0    	/* bit 0 */
#define FLED1     	LEDCR1bits.FLED1    	/* bit 1 */
#define IREFEN    	LEDCR1bits.IREFEN   	/* bit 2 */
#define IBPS0     	LEDCR1bits.IBPS0    	/* bit 3 */
#define IBPS1     	LEDCR1bits.IBPS1    	/* bit 4 */
