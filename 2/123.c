/*=============================================================
  ...
  (C)opyright 2018 All rights reserved
  ...
  Compiler: SN8 C Studio_V149
   	   	   	   	   	   	   	
  Written by:
     Lulu  @_@  Feb-7-2018 10:03:41 AM
   	   	 
   	 Program Description

  Revision History:
     Rev              Name      Date           Description
     R1(0xC10A)       Lulu      Mar-12-2018    Initially constructed 
...
/************SetAlarmAddTimerPROCEDURE**********************
 ...
 ----------------------------------------------------------*/  
void Sub_SetAlarmAddTimer(void)  //去掉
{
...
/************Up_AlShortLongKeyAlarmSet  PROCEDURE************
 ...
 ----------------------------------------------------------*/  
void Sub_Up_AlShortLongKeyAlarmSet(void)//去掉
{
   	if(GV_AlarmClockSetStep==0)
   	{
...
{
   	unsigned char  	LV_TempYear,LV_TempMonth;
...
{
   	unsigned char  	LV_TempYear,LV_TempMonth,LV_TempDay,LV_TenTemp;
