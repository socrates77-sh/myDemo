...
#define PPGLDH_ADDR     	0x01C1
#define PPGLDL_ADDR     	0x01C2
#define PPGTDL_ADDR     	0x01C3
#define PPGTDB_ADDR     	0x01C4
#define OPACR_ADDR      	0x01C5
#define OPACLR_ADDR     	0x01C6
...
extern __sfr __at (PPGLDH_ADDR)   	PPGLDH;
extern __sfr __at (PPGLDL_ADDR)   	PPGLDL;
...
#define VLVDS     	LVDCRbits.VLVDS     	/* bit 4 */
...
#define IICDT5    	IICDRbits.IICDT5    	/* bit 5 */
...
#define CPVIREN   	ADCR0bits.CPVIREN   	/* bit 3 */
...
extern volatile __PPGLDHbits_t __at(PPGLDH_ADDR) PPGLDHbits;

#define PGLOAD8   	PPGLDHbits.PGLOAD8  	/* bit 0 */
#define PGLOAD9   	PPGLDHbits.PGLOAD9  	/* bit 1 */
...
extern volatile __PPGLDLbits_t __at(PPGLDL_ADDR) PPGLDLbits;

#define PGLOAD0   	PPGLDLbits.PGLOAD0  	/* bit 0 */
#define PGLOAD1   	PPGLDLbits.PGLOAD1  	/* bit 1 */
#define PGLOAD2   	PPGLDLbits.PGLOAD2  	/* bit 2 */
#define PGLOAD3   	PPGLDLbits.PGLOAD3  	/* bit 3 */
#define PGLOAD4   	PPGLDLbits.PGLOAD4  	/* bit 4 */
#define PGLOAD5   	PPGLDLbits.PGLOAD5  	/* bit 5 */
#define PGLOAD6   	PPGLDLbits.PGLOAD6  	/* bit 6 */
#define PGLOAD7   	PPGLDLbits.PGLOAD7  	/* bit 7 */
...
typedef union {
	 struct {
		unsigned char OPACLR0:1;
		unsigned char OPACLR1:1;
		unsigned char OPACLR2:1;
		unsigned char OPACLR3:1;
		unsigned char OPACLR4:1;
		unsigned char OPACLR5:1;
...
#define OPACLR0   	OPACLRbits.OPACLR0  	/* bit 0 */
#define OPACLR1   	OPACLRbits.OPACLR1  	/* bit 1 */
#define OPACLR2   	OPACLRbits.OPACLR2  	/* bit 2 */
#define OPACLR3   	OPACLRbits.OPACLR3  	/* bit 3 */
#define OPACLR4   	OPACLRbits.OPACLR4  	/* bit 4 */
#define OPACLR5   	OPACLRbits.OPACLR5  	/* bit 5 */
...
typedef union {
	 struct {
		...
		unsigned char CP2VS1:1;
		unsigned char CP2VS2:1;
		unsigned char CPVRS:1;
	};
} __CPVR0bits_t;
...
#define CP2VS1    	CPVR0bits.CP2VS1    	/* bit 5 */
#define CP2VS2    	CPVR0bits.CP2VS2    	/* bit 6 */
#define CPVRS     	CPVR0bits.CPVRS     	/* bit 7 */
