...
#define P12ANS    	ANSELbits.P12ANS    	/* bit 4 */
#define P13ANS    	ANSELbits.P13ANS    	/* bit 5 */
...
#define FPWMF0    	PWMCRbits.FPWMF0    	/* bit 0 */
#define FPWMF1    	PWMCRbits.FPWMF1    	/* bit 1 */
#define FPWMR0    	PWMCRbits.FPWMR0    	/* bit 2 */
#define FPWMR1    	PWMCRbits.FPWMR1    	/* bit 3 */
#define PMODE0    	PWMCRbits.PMODE0    	/* bit 4 */
#define PMODE1    	PWMCRbits.PMODE1    	/* bit 5 */
#define PWMINV    	PWMCRbits.PWMINV    	/* bit 6 */
#define FPWMEN    	PWMCRbits.FPWMEN    	/* bit 7 */
...
#define VRES      	ADCR1bits.VRES      	/* bit 3 */
