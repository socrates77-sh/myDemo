...
; This file was generated Tue May 29 11:16:25 2018
;--------------------------------------------------------
...
;	.line	470; "main.c"	if( choice_vol == 48 )
	...
	JBSET	PFLAG,2
	GOTO	_00296_DS_
;;gen.c:6374: size=1/2, offset=0, AOP_TYPE(res)=8
;	.line	472; "main.c"	Stalls_Bat[0] = Stalls0_48V;
	MOVAI	0xa4
	MOVRA	(_Stalls_Bat + 0)
;;gen.c:6374: size=0/2, offset=1, AOP_TYPE(res)=8
	MOVAI	0x01
	MOVRA	(_Stalls_Bat + 1)
;;gen.c:6374: size=1/2, offset=0, AOP_TYPE(res)=8
...
;	 1671+    0 =  1671 instructions ( 3342 byte)
