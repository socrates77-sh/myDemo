...
#define BF_SetAlarmAM_PM   	   	UserFlag1.bits.bit2  //Ϊ0ʱ=AM��Ϊ1=PM
#define BF_RunAlarmAM_PM   	   	UserFlag1.bits.bit3  //Ϊ0ʱ=AM��Ϊ1=PM
...
void Sub_SendDispDataToTA6932(void);
...
/************ReadByteFromDS1302 PROCEDURE************************
 ...
 --------------------------------------------------------------*/  
void Sub_Read1302(unsigned char	LV_Addr) // ��DS1302ĳ����ַ������
{
   	unsigned char  	i,LV_TempE;	
   	PO_1381A_SCLK = 0; 	
   	Enable1381A_RESET();
   	
   	LV_Addr=(LV_Addr|0x01); // ��ַ������ 
   	PO_1381A_DAT = 0;
   	Set1381A_I_O_ForOutput();
   	for(i=8;i>0;i--)
   	{
...
/************WriteByteFromDS1302 PROCEDURE***********************
 ...
 ---------------------------------------------------------------*/  
void Sub_Write1302(unsigned char LV_Addr,unsigned char LV_Data) // ������д��DS1302ĳ����ַ
{
   	unsigned char  	i,LV_TempE;	
   	PO_1381A_SCLK =0;  	
   	Enable1381A_RESET();
   	
   	//Sub_SendByteToDS1302(LV_Addr|0x00); // ��ַ������ 
   	//Sub_SendByteToDS1302(LV_Data);      // ������д���ַ
...
/*void Sub_TC0Initial(void)//TC1 for pwm1
{
   	...
   	TC0C = 0x06; //TC1C ��?�MTC2R �۵��C
   	TC0R = 0x06;

   	TC0D = C_SpeedLowPwmDuty;  //TC0D ���ȥ�?�j�_TC0R ���ȡCDuty = 35%
...
void Sub_Initial(void)
{
   	...
   	Sub_Write1302(C_DS1302_Hour,C_DS1302_AM12HrData);//(RTCʱ�Ĵ�����Bit7=0Ϊ24Сʱ�ƣ�Bit7=1Ϊ12Сʱ�ƣ���Ϊ12Сʱ��ʱ��ʱ�Ĵ�����Bit5Ϊ0ʱ=AM��Ϊ1=PM����)	
...
void Sub_RealTimeClockAdd(void)  //
{
   	...
   	else if(GV_RealTimeClockSetStep==2)
   	{
       	   	   	...
       	   	   	LV_TempB = (LV_TempA>>4)*10;//BCD_TO_HEXʮ����ת��ʮ�����Ƶĳ���
           	   	...
           	   	{
       	   	   	   	   	   	  if(LV_TempYear % 4)//�ܱ�4������Ϊ����(2��Ϊ29��),����Ϊƽ��(2��Ϊ28��)
   	   	   	   	   	   	   	{
   	   	   	   	   	   	   	   	if(GV_SetDaySingleDig >= 10)
   	   	   	   	   	   	   	   	{
   	   	   	   	   	   	   	   	   	GV_SetDaySingleDig = 0;
  ...
  else
  {
    ...
    //         	   	LV_TempMonth = LV_TempMonth + LV_TempB;
    //
   	//     	   	   	//ÿ���������㣺1,3,5,7,8,10,12 �⼸����Զ31��
   	//     	   	   	//2��ƽ��28�죬����29�죨һ�����������4��������������400�������꣬��
   	//     	   	   	//�����·�30��
   	//     	   	   	//���ϼ��㷽��˵��������
   	//     	   	   	
   	//     	   	   	//���������ж���ѭ�Ĺ���Ϊ: ����һ��,���겻��,�İ�������.
    ...
    //
   	//     	   	   	//��ͨ�꣨���ܱ�100��������ݣ��ܱ�4������Ϊ���ꡣ����2004���������,1999�겻�����꣩��
   	//     	   	   	//�����꣨�ܱ�100��������ݣ��ܱ�400�����������ꡣ(��2000�������꣬1900�겻������)��
   	//     	   	   	
   	//     	   	   	//����ָ���ǵ���������ѹ���4���������磺2000��������꣬2000����4����500.����������
   	//     	   	   	//ƽ������������˵ģ����磺2001�����ƽ�꣬2001����4����500��1������ƽ�ꡣ
   	//     	   	   	//���������ģ������𣬺�����Ϊ���� 
   	//     	   	   	GV_SetDaySingleDig++;  	   	   	   	   	   	   	   	   	   	   	
   	//     	   	   	switch(LV_TempMonth) 
   	//     	   	   	{
...
void Sub_SetLongKeyGetRealTimeClockSetMode(void)
{
     	...
     	// LV_TempB = LV_TempA;
     	// GV_SetRealTimeClockHrTenDig = LV_TempA & 0x01;
...
void Sub_SetKeyRealTimeClockEnter(void)  //
{
   	...
   	else if(GV_RealTimeClockSetStep==3)
   	{
   	   	   	   	...
   	   	   	   	LV_TenTemp <<= 4;
   	   	   	   	if(BF_SetRealTimeClockAM_PM)//Ϊ0ʱ=AM��Ϊ1=PM
   	   	   	   	{
   	   	   	   	   	LV_TenTemp |= 0xA0;//(RTCʱ�Ĵ�����Bit7=0Ϊ24Сʱ�ƣ�Bit7=1Ϊ12Сʱ�ƣ�Ϊ12Сʱ��ʱ��ʱ�Ĵ�����Bit5Ϊ0ʱ=AM��Ϊ1=PM
   	   	   	   	}
   	   	   	   	else
   	   	   	   	{
   	   	   	   	   	LV_TenTemp |= 0x80;//(RTCʱ�Ĵ�����Bit7=0Ϊ24Сʱ�ƣ�Bit7=1Ϊ12Сʱ�ƣ�Ϊ12Сʱ��ʱ��ʱ�Ĵ�����Bit5Ϊ0ʱ=AM��Ϊ1=PM����)
   	   	   	   	}
            ...
            //
   	   	...
   	   	if(GV_CurKey == 0x70)//0111 0000 ShortKey,no return;
   	   	{
   	   	   	...
   	   	   	else
   	   	   	{
   	   	   	   	if(GV_Mode == 0)
   	   	   	   	{
   	   	   	   	   	if(++GV_DisplayBrightnessLevel > 2)//������ģʽ�µ�������Ļ�ƹ�����3��λѭ������
   	   	   	   	   	{
...
void Sub_SendDispDataToTA6932(void)//Per 10ms
{
   	...
   	if(GV_Mode==0)
   	{
   	   	   	   	if(BF_RunAlarmOnOff)//0 = Run alarm off; 1 = Run alarm on
   	   	   	   	{
   	   	   	   	   	...
   	   	   	   	   	if(BF_RunAlarmAM_PM)//Ϊ0ʱ=AM��Ϊ1=PM
   	   	   	   	   	{
   	...
   	else if(GV_Mode==2)
   	{
   	   	   	   	...
   	   	   	   	if(BF_SetAlarmAM_PM)//Ϊ0ʱ=AM��Ϊ1=PM
   	   	   	   	{
