...
; This file was generated Sat Sep 30 13:57:03 2017
;--------------------------------------------------------
...
;@main i                         Allocated to registers r0x1001 ;size:1
...
; 2 exit points
;	.line	11; "decr.c"	a = MCR;
	MOVAR	_MCR
	MOVRA	r0x1000
;	.line	12; "decr.c"	IOP0 = a;
	MOVAR	r0x1000
	MOVRA	_IOP0
;	.line	13; "decr.c"	b = a - 1;
	DJZR	r0x1000
	NOP	
;	.line	14; "decr.c"	IOP1 = b;
	MOVAR	r0x1000
	MOVRA	_IOP1
;	.line	28; "decr.c"	for(i=0; i++; i<10)
	CLRR	r0x1001
_00108_DS_
	MOVAR	r0x1001
	MOVRA	r0x1002
	...
	JBCLR	STATUS,2
	GOTO	_00106_DS_
;	.line	30; "decr.c"	IOP0 = i;
	MOVAR	r0x1001
	MOVRA	_IOP0
;	.line	32; "decr.c"	b = a - 1;
	DJZAR	r0x1001
	NOP	
	MOVRA	_IOP1
;	.line	28; "decr.c"	for(i=0; i++; i<10)
