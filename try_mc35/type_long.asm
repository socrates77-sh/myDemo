...
; This file was generated Wed Sep 27 18:21:33 2017
;--------------------------------------------------------
...
; 2 exit points
;	.line	8; "type_long.c"	c_a = MCR;
	MOVAR	_MCR
	MOVRA	_c_a
	CLRR	(_c_a + 1)
	CLRR	(_c_a + 2)
	CLRR	(_c_a + 3)
;	.line	9; "type_long.c"	c_b = KBIM;
	MOVAR	_KBIM
	MOVRA	_c_b
	CLRR	(_c_b + 1)
	CLRR	(_c_b + 2)
	CLRR	(_c_b + 3)
;	.line	10; "type_long.c"	uc_a = MCR;
	MOVAR	_MCR
	MOVRA	_uc_a
	CLRR	(_uc_a + 1)
	CLRR	(_uc_a + 2)
	CLRR	(_uc_a + 3)
;	.line	11; "type_long.c"	uc_b = KBIM;
	MOVAR	_KBIM
	MOVRA	_uc_b
	CLRR	(_uc_b + 1)
	CLRR	(_uc_b + 2)
	CLRR	(_uc_b + 3)
;	.line	13; "type_long.c"	IOP0 = c_a + c_b;
	MOVAR	_c_a
	MOVRA	r0x1010
	MOVAR	_c_b
	MOVRA	r0x1011
	...
	ADDAR	r0x1010
	MOVRA	_IOP0
;	.line	14; "type_long.c"	IOP0 = uc_a + uc_b;
	MOVAR	_uc_a
	MOVRA	r0x1012
	MOVAR	_uc_b
	MOVRA	r0x1013
	...
	ADDAR	r0x1012
	MOVRA	_IOP0
;	.line	15; "type_long.c"	IOP1 = c_a - c_b;
	MOVAR	r0x1011
	RSUBAR	r0x1010
	MOVRA	_IOP1
;	.line	16; "type_long.c"	IOP1 = uc_a - uc_b;
	MOVAR	r0x1013
	RSUBAR	r0x1012
	MOVRA	_IOP1
;;swapping arguments (AOP_TYPEs 1/3)
;;signed compare: left >= lit(0x1=1), size=4, mask=ffffffff
;	.line	18; "type_long.c"	if (c_a > 0) IOP0 = c_b;
	MOVAR	(_c_a + 3)
	ADDAI	0x80
	ADDAI	0x80
	JBSET	STATUS,2
...
;;genSkipc:3194: created from rifx:00D4608C
	...
	MOVRA	_IOP0
_00106_DS_
;	.line	19; "type_long.c"	if (uc_a > 0) IOP0 = uc_b;
	MOVAR	_uc_a
	ORAR	(_uc_a + 1)
	ORAR	(_uc_a + 2)
	ORAR	(_uc_a + 3)
	...
	MOVRA	_IOP0
;;swapping arguments (AOP_TYPEs 1/3)
;;signed compare: left >= lit(0xFFFFFFFE=-2), size=4, mask=ffffffff
_00108_DS_
;	.line	21; "type_long.c"	if (c_a > -3) IOP0 = c_b;
	MOVAR	(_c_a + 3)
	ADDAI	0x80
	ADDAI	0x81
	JBSET	STATUS,2
...
;;genSkipc:3194: created from rifx:00D4608C
	...
	MOVRA	_IOP0
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit(0xFFFFFFFE=4294967294), size=4
_00110_DS_
;	.line	22; "type_long.c"	if (uc_a > -3) IOP0 = uc_b;
	MOVAI	0xff
	RSUBAR	(_uc_a + 3)
	JBSET	STATUS,2
	GOTO	_00130_DS_
...
;	  106+    0 =   106 instructions (  212 byte)
