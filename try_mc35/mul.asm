...
; This file was generated Wed Sep 27 18:13:48 2017
;--------------------------------------------------------
...
; 2 exit points
;	.line	7; "mul.c"	c_a = MCR;
	MOVAR	_MCR
	MOVRA	_c_a
;	.line	8; "mul.c"	c_b = IOP1;
	MOVAR	_IOP1
	MOVRA	_c_b
;	.line	10; "mul.c"	IOP0 = c_a * c_b;
	MOVAR	_c_b
	MOVRA	STK00
	MOVAR	_c_a
	CALL	__mulchar
...
;	.line	12; "mul.c"	if (c_a > 0) IOP0 = c_b;
	MOVAR	_c_a
	ADDAI	0x80
	ADDAI	0x7f
	JBSET	STATUS,0
...
_00106_DS_
;	.line	14; "mul.c"	if (c_a > -3) IOP0 = c_b;
	MOVAR	_c_a
	ADDAI	0x80
	ADDAI	0x82
	JBSET	STATUS,0
