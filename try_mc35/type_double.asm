...
; This file was generated Wed Sep 27 18:18:59 2017
;--------------------------------------------------------
...
;	.line	7; "type_double.c"	c_a = 1.13;
	...
	MOVAI	0x3f
	MOVRA	(_c_a + 3)
;	.line	9; "type_double.c"	IOP0 = c_a;
	MOVAI	0x01
	MOVRA	_IOP0
_00106_DS_
;	.line	11; "type_double.c"	while(1);
	GOTO	_00106_DS_
	RETURN	
; exit point of _main
