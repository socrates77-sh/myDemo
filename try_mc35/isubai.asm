...
; This file was generated Sat Sep 30 18:23:25 2017
;--------------------------------------------------------
...
;@main b                         Allocated to registers ;size:1
...
; 2 exit points
;	.line	11; "isubai.c"	a = MCR;
	MOVAR	_MCR
	MOVRA	r0x1000
;	.line	12; "isubai.c"	IOP0 = a;
	MOVAR	r0x1000
	MOVRA	_IOP0
;	.line	13; "isubai.c"	b = a - IOP1;
	MOVAR	_IOP1
	XCH	r0x1000
	ASUBRA	r0x1000
	XCH	r0x1000
