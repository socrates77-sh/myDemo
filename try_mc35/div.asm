...
; This file was generated Wed Sep 27 18:10:01 2017
;--------------------------------------------------------
...
; 2 exit points
;	.line	7; "div.c"	c_a = MCR;
	MOVAR	_MCR
	MOVRA	_c_a
;	.line	8; "div.c"	c_b = IOP1;
	MOVAR	_IOP1
	MOVRA	_c_b
;	.line	10; "div.c"	IOP0 = c_a / c_b;
	MOVAR	_c_b
	MOVRA	STK00
	MOVAR	_c_a
	CALL	__divschar
...
;	.line	12; "div.c"	if (c_a > 0) IOP0 = c_b;
	MOVAR	_c_a
	ADDAI	0x80
	ADDAI	0x7f
	JBSET	STATUS,0
...
_00106_DS_
;	.line	14; "div.c"	if (c_a > -3) IOP0 = c_b;
	MOVAR	_c_a
	ADDAI	0x80
	ADDAI	0x82
	JBSET	STATUS,0
