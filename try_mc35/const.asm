...
; This file was generated Wed Sep 27 18:07:05 2017
;--------------------------------------------------------
...
; 2 exit points
;	.line	9; "const.c"	c_a = MCR;
	MOVAR	_MCR
	MOVRA	_c_a
;;genAssign from CODESPACE
;	.line	12; "const.c"	IOP0 = c_a + c_b;
	MOVAR	low (_c_b+0)
	MOVRA	STK01
	MOVAR	low (_c_b+1)
	MOVRA	STK00
	...
	ADDAR	_c_a
	MOVRA	_IOP0
;	.line	13; "const.c"	IOP1 = c_a - c_b;
	MOVAR	r0x1001
	RSUBAR	_c_a
	MOVRA	_IOP1
;;swapping arguments (AOP_TYPEs 1/3)
;;signed compare: left >= lit(0x1=1), size=1, mask=ff
;	.line	15; "const.c"	if (c_a > 0) IOP0 = c_b;
	MOVAR	_c_a
	ADDAI	0x80
	ADDAI	0x7f
	JBSET	STATUS,0
...
_00106_DS_
;	.line	17; "const.c"	if (c_a > -3) IOP0 = c_b;
	MOVAR	_c_a
	ADDAI	0x80
	ADDAI	0x82
	JBSET	STATUS,0
