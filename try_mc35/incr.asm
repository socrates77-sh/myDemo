...
; This file was generated Sat Sep 30 12:13:14 2017
;--------------------------------------------------------
...
; 2 exit points
;	.line	11; "incr.c"	a = MCR;
	MOVAR	_MCR
	MOVRA	r0x1000
;	.line	12; "incr.c"	IOP0 = a;
	MOVAR	r0x1000
	MOVRA	_IOP0
;	.line	13; "incr.c"	b = a + 1;
	MOVAI	0x01
	ADDRA	r0x1000
;	.line	14; "incr.c"	IOP1 = b;
	MOVAR	r0x1000
	MOVRA	_IOP1
;	.line	28; "incr.c"	for(i=0; i++; i<10)
	CLRR	r0x1001
_00108_DS_
	MOVAR	r0x1001
	MOVRA	r0x1002
	...
	JBCLR	STATUS,2
	GOTO	_00106_DS_
;	.line	30; "incr.c"	IOP0 = i;
	MOVAR	r0x1001
	MOVRA	_IOP0
;	.line	32; "incr.c"	b = a + 1;
	JZAR	r0x1001
	NOP	
	MOVRA	_IOP1
;	.line	28; "incr.c"	for(i=0; i++; i<10)
