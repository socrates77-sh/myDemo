...
#define PDRVS1    	DRVCRbits.PDRVS1    	/* bit 5 */
...
#define T2PR2     	T2CRbits.T2PR2      	/* bit 2 */
...
typedef union {
	 struct {
		unsigned char T3PR0:1;
		unsigned char T3PR1:1;
		unsigned char T3PR2:1;
		unsigned char T3PTS0:1;
		unsigned char T3PTS1:1;
		unsigned char :1;
		unsigned char :1;
...
#define T3PR0     	T3CRbits.T3PR0      	/* bit 0 */
#define T3PR1     	T3CRbits.T3PR1      	/* bit 1 */
#define T3PR2     	T3CRbits.T3PR2      	/* bit 2 */
#define T3PTS0    	T3CRbits.T3PTS0     	/* bit 3 */
#define T3PTS1    	T3CRbits.T3PTS1     	/* bit 4 */
...
extern volatile __PWM2DEbits_t __at(PWM2DE_ADDR) PWM2DEbits;
...
#define ADCKS0    	ADCR1bits.ADCKS0    	/* bit 5 */
...
#define P02ANS    	ANSEL0bits.P02ANS   	/* bit 1 */
#define P03ANS    	ANSEL0bits.P03ANS   	/* bit 2 */
#define P04ANS    	ANSEL0bits.P04ANS   	/* bit 3 */
#define P05ANS    	ANSEL0bits.P05ANS   	/* bit 4 */
#define P10ANS    	ANSEL0bits.P10ANS   	/* bit 5 */
