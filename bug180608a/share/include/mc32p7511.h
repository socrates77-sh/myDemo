...
#define PWM0DE_ADDR     	0x0198
#define PWM1DE_ADDR     	0x0199
...
#define PMODE0    	PWM0DEbits.PMODE0   	/* bit 3 */
#define PWM0INV   	PWM0DEbits.PWM0INV  	/* bit 4 */
...
#define PMODE1    	PWM1DEbits.PMODE1   	/* bit 3 */
#define PWM1INV   	PWM1DEbits.PWM1INV  	/* bit 4 */
...
#define P13SP     	AUCRbits.P13SP      	/* bit 4 */
#define P04WP     	AUCRbits.P04WP      	/* bit 5 */
#define SPDSL     	AUCRbits.SPDSL      	/* bit 6 */
#define DRVEN     	AUCRbits.DRVEN      	/* bit 7 */
...
#define P00ANS    	AN0SELbits.P00ANS   	/* bit 0 */
#define P01ANS    	AN0SELbits.P01ANS   	/* bit 1 */
#define P02ANS    	AN0SELbits.P02ANS   	/* bit 2 */
#define P03ANS    	AN0SELbits.P03ANS   	/* bit 3 */
#define P04ANS    	AN0SELbits.P04ANS   	/* bit 4 */
#define P05ANS    	AN0SELbits.P05ANS   	/* bit 5 */
#define P06ANS    	AN0SELbits.P06ANS   	/* bit 6 */
...
#define P10ANS    	AN1SELbits.P10ANS   	/* bit 0 */
#define P11ANS    	AN1SELbits.P11ANS   	/* bit 1 */
#define P12ANS    	AN1SELbits.P12ANS   	/* bit 2 */
#define P13ANS    	AN1SELbits.P13ANS   	/* bit 3 */
#define P14ANS    	AN1SELbits.P14ANS   	/* bit 4 */
#define P15ANS    	AN1SELbits.P15ANS   	/* bit 5 */
#define P16ANS    	AN1SELbits.P16ANS   	/* bit 6 */
...
typedef union {
	 struct {
		unsigned char ADPT0:1;
		unsigned char ADPT1:1;
		unsigned char ADPT2:1;
		unsigned char ADPT3:1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
...
#define ADPT0     	ADCR2bits.ADPT0     	/* bit 0 */
#define ADPT1     	ADCR2bits.ADPT1     	/* bit 1 */
#define ADPT2     	ADCR2bits.ADPT2     	/* bit 2 */
#define ADPT3     	ADCR2bits.ADPT3     	/* bit 3 */
