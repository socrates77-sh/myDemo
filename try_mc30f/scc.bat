...
set GPLINK_ARG=-s %SNLIB%\share\lkr\0311.lkr ^
%SNLIB%\share\lib\0311.lib ^
-w -m -c

set SDCC_ARG=-V --verbose --use-non-free --start-addr 0x3ff --fl-mode -mmc30 -p0311 ^
-I"%SNLIB%\share\include" ^
-Wa"-I%SNLIB%\share\header" ^
-Wl"-s%SNLIB%\share\lkr\0311.lkr" ^
